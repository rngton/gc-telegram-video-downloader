...
# We tell Uvicorn to listen on this port. The ':-8080' provides a default if PORT isn't set (e.g. for local testing).
CMD ["uvicorn", "app:app", "--host", "0.0.0.0", "--port", "${PORT:-8080}", "--log-level", "info"]
